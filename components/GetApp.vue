            ...
            <div class="mt-2 xl:mt-4 lg:flex lg:items-center">
                <div class="w-full lg:w-1/2 grid grid-cols-1 gap-8 xl:gap-16 md:grid-cols-2">
                    ...
                    <!-- <div class="space-y-3">
                        ...
                        <h1 class="text-2xl font-semibold text-gray-700 capitalize dark:text-white">elegant Dark Mode
                        </h1>
                ...
                <div class="hidden lg:flex lg:w-1/2 lg:justify-center">
                    <img class="w-full h-full flex-shrink-0 object-cover xl:w-2/3 xl:h-2/3 rounded-full"
                        src="https://10minuteschool.com/assets/icons/home-page/app-download.png" alt="">
                </div>
            </div>
        </div>
    </section>
